...
Private Sub cmdAccion_Click(Index As Integer)
    ...
    Select Case Index
        ...
        Case 11 '/CARCEL NICK @ MOTIVO  0.12.1
            ...
            If IsNumeric(tmp) Then
                If CLng(tmp) >= 1 And CLng(tmp) <= 60 Then
                    Call WriteJail(cboListaUsus.text, "encarcelado via panelgm", CLng(tmp))
                Else
...
Private Sub mnuCarcel_Click(Index As Integer)
    ...
    If Index = 60 Then
        ...
        Exit Sub
    End If
    If Index >= 1 And Index <= 59 Then
        Call WriteJail(cboListaUsus.text, "encarcelado via panelgm", Index)
    End If
    Exit Sub
mnuCarcel_Click_Err:
...
Public Sub CadenaChat(ByVal chat As String)
    ...
    If UBound(partes) >= 1 Then
        ...
        If PosicionBarra > 0 Then
            ...
            Call ProcesarAccionMacro(nombre, frmPanelgm.chkPaquetes.value = 1, frmPanelgm.chkPaquetesCarcel.value = 1)
        End If
    End If
        ...
        If PosicionBarra > 0 Then
            ...
            Select Case True
                    ...
                    'Call ParseUserCommand("/MENSAJEINFORMACION " & nombre & "@" & "INFORMACION: Le recordamos que el uso de macros o programas externos está estrictamente prohibido y puede resultar en sanciones.")
                        If frmPanelgm.cboListaUsus.text = nombre Then
                            ...
                            If TiempoActual - TiempoAnterior < frmPanelgm.txtSegundos Then
                                Call ProcesarAccionMacro(nombre, frmPanelgm.chkOcultar.value = 1, frmPanelgm.chkOcultarCarcel.value = 1)
                            End If
                ...
                Case InStr(Cadena, "UseItemU") > 0
                    ...
                    'Call ParseUserCommand("/MENSAJEINFORMACION " & nombre & "@" & "INFORMACION: Le recordamos que el uso de macros o programas externos está estrictamente prohibido y puede resultar en sanciones.")
                    Call ProcesarAccionMacro(nombre, frmPanelgm.chkUsarItem.value = 1, frmPanelgm.chkUsarItemCarcel.value = 1)
                ...
                Case InStr(Cadena, "LeftClick") > 0
                    ...
                    'Call ParseUserCommand("/MENSAJEINFORMACION " & nombre & "@" & "INFORMACION: Le recordamos que el uso de macros o programas externos está estrictamente prohibido y puede resultar en sanciones.")
                    Call ProcesarAccionMacro(nombre, frmPanelgm.chkLeftClick.value = 1, frmPanelgm.chkLeftClickCarcel.value = 1)
        ...
        If PosicionBarra > 0 Then
            ...
            Select Case True
                Case InStr(Cadena, "Macro de Cordenadas") > 0
                    ...
                    'Call ParseUserCommand("/MENSAJEINFORMACION " & nombre & "@" & "INFORMACION: Le recordamos que el uso de macros o programas externos está estrictamente prohibido y puede resultar en sanciones.")
                    Call ProcesarAccionMacro(nombre, frmPanelgm.chkCoordenadas.value = 1, frmPanelgm.chkCoordenadasCarcel.value = 1)
                Case InStr(Cadena, ").") > 0
                    If chkInfoTXT.value = 1 Then Resultado = GuardarTextoEnArchivo(nombre & ",Macro de click", "MacroDeClick.txt")
                    'Call ParseUserCommand("/MENSAJEINFORMACION " & nombre & "@" & "INFORMACION: Le recordamos que el uso de macros o programas externos está estrictamente prohibido y puede resultar en sanciones.")
                    Call ProcesarAccionMacro(nombre, frmPanelgm.chkClicks.value = 1, frmPanelgm.chkClicksCarcel.value = 1)
                Case InStr(Cadena, "Macro Inasistido") > 0
                    ...
                    'Call ParseUserCommand("/MENSAJEINFORMACION " & nombre & "@" & "INFORMACION: Le recordamos que el uso de macros o programas externos está estrictamente prohibido y puede resultar en sanciones.")
                    Call ProcesarAccionMacro(nombre, frmPanelgm.chkInasistido.value = 1, frmPanelgm.chkInasistidoCarcel.value = 1)
                Case InStr(Cadena, "Macro de Carteleo") > 0
                    ...
                    'Call ParseUserCommand("/MENSAJEINFORMACION " & nombre & "@" & "INFORMACION: Le recordamos que el uso de macros o programas externos está estrictamente prohibido y puede resultar en sanciones.")
                    Call ProcesarAccionMacro(nombre, frmPanelgm.chkCarteleo.value = 1, frmPanelgm.chkCarteleoCarcel.value = 1)
                Case Else
                    ' Manejar el caso en el que no hay coincidencias
            End Select
            If frmPanelgm.chkAutoName.value = 1 Then frmPanelgm.cboListaUsus.text = nombre
...
Private Sub ProcesarAccionMacro(ByVal nombre As String, ByVal cerrarCliente As Boolean, ByVal mandarCarcel As Boolean)
    ' Prioridad de acción:
    ' 1) Si está tildado Carcel, manda a carcel.
    ' 2) Si no, y está tildado el check base, cierra cliente.
    ' 3) Si no hay checks tildados, no sanciona (solo se guarda informe/log).
    If mandarCarcel Then
        Call AplicarSancionMacro(nombre, True)
    ElseIf cerrarCliente Then
        Call AplicarSancionMacro(nombre, False)
    End If
End Sub
