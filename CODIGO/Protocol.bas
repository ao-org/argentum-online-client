...
'***************************************************
    ...
    frmmain.panelInf.Picture = LoadInterface("primerapest.bmp")
...
'***************************************************
    ...
    For i = 1 To MAX_INVENTORY_SLOTS
        With frmmain.Inventario
            Call frmComerciar.InvComUsu.SetItem(i, .OBJIndex(i), _
...
'***************************************************
    ...
    For i = 1 To MAX_INVENTORY_SLOTS
        With frmmain.Inventario
            Call frmBancoObj.InvBankUsu.SetItem(i, .OBJIndex(i), _
                .Amount(i), .Equipped(i), .GrhIndex(i), _
                .ObjType(i), .MaxHit(i), .MinHit(i), .Def(i), _
                .Valor(i), .ItemName(i), .PuedeUsar(i))
        End With
...
'***************************************************
    ...
    charlist(UserCharIndex).dialogEfec = "Falla"
    charlist(UserCharIndex).SubeEfecto = 180
    charlist(UserCharIndex).dialog_Efect_color.r = 255
    charlist(UserCharIndex).dialog_Efect_color.a = 255
End Sub
...
'***************************************************
    ...
    charlist(UserCharIndex).dialogEfec = "Fallas"
    charlist(UserCharIndex).SubeEfecto = 180
    charlist(UserCharIndex).dialog_Efect_color.r = 255
    charlist(UserCharIndex).dialog_Efect_color.g = 0
    charlist(UserCharIndex).dialog_Efect_color.b = 0
    charlist(UserCharIndex).dialog_Efect_color.a = 255
...
On Error GoTo errhandler
   ...
   ' Debug.Print color
    ...
    charlist(charindex).SubeEfecto = 180
...
On Error GoTo errhandler
    ...
    With SlotInv
        ...
        Call frmComerciar.InvComNpc.SetItem(slot, .OBJIndex, _
            .Amount, 0, .GrhIndex, _
            .ObjType, .MaxHit, .MinHit, .Def, _
            .Valor, .name, .PuedeUsar)
    End With
