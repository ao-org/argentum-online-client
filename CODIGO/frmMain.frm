...
Begin VB.Form frmmain 
   ...
   Begin VB.PictureBox panel 
      ...
      Begin VB.Image cmdMoverHechi 
         ...
         Index           =   1
         Left            =   3370
         MouseIcon       =   "frmMain.frx":65E28
         MousePointer    =   99  'Custom
         Picture         =   "frmMain.frx":65F7A
         Tag             =   "0"
         Top             =   4260
         Visible         =   0   'False
         Width           =   315
