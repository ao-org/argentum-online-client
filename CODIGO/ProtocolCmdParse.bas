...
Public Sub ParseUserCommand(ByVal RawCommand As String)
    ...
    If Left$(Comando, 1) = "/" Then
        ...
        Select Case Comando
            ...
            Case "/TELEP"
                ...
                If notNullArguments Then
                    If CantidadArgumentos >= 4 Then
                        ...
                        Else
                            Call ShowConsoleMsg(JsonLanguage.Item("MENSAJE_TELEP_INVALIDO"))
            ...
            Case "/SILENCIAR", "/MUTE"
                ...
                If notNullArguments Then
                    ...
                    Else
                        ...
                        Call ShowConsoleMsg(JsonLanguage.Item("MENSAJE_FALTAN_SILENCIAR"))
            ...
            Case "/CUENTAREGRESIVA", "/CR", "/COUNTDOWN"
            ...
            Case "/IRA"
                ...
                If EsGM Then
                    ...
                    Else
                        Call ShowConsoleMsg(JsonLanguage.Item("MENSAJE_FALTAN_IRA"))
            ...
            Case "/GO"
                ...
                If EsGM Then
                    ...
                    Else
                        Call ShowConsoleMsg(JsonLanguage.Item("MENSAJE_FALTAN_GO"))
            ...
            Case "/LUZ"
                ...
                If EsGM Then
                    If notNullArguments Then
                        ...
                        Else
                            Call ShowConsoleMsg(JsonLanguage.Item("MENSAJE_LUZ_NUM_INCORRECTO"))

                        End If

                    Else
                        Call ShowConsoleMsg(JsonLanguage.Item("MENSAJE_LUZ_FALTANTE"))
            ...
            Case "/BANCUENTA"
                ...
                If notNullArguments Then
                    ...
                    Else
                        'Faltan los parámetros con el formato propio
                        Call ShowConsoleMsg(JsonLanguage.Item("MENSAJE_FALTAN_BANCUENTA"))
