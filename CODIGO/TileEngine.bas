...
Sub DoPasosFx(ByVal charindex As Integer)
    ...
    If Not charlist(charindex).Navegando Then
        ...
        With charlist(charindex)
            ...
            steps_vol = ao20audio.calculate_charfx_volume(.Pos)
            steps_pan = ao20audio.calculate_charfx_pan(.Pos)
...
On Error GoTo DoPasosInvi_Err
    ...
    If grh > 0 Then
        ...
        Dim steps_vol As Long
        Dim steps_pan As Long
        steps_vol = ao20audio.calculate_charfx_volume_by_distance(distancia)
        steps_pan = ao20audio.calculate_charfx_pan_by_distance(distancia, balance)
