...
Public Sub DebugPrint(ByVal str As String, _
                      Optional ByVal int1 As Integer = 0, _
                      Optional ByVal int2 As Integer = 0, _
                      Optional ByVal int3 As Integer = 0, _
                      Optional ByVal asd As Boolean = False)
