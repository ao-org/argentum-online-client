...
If UserMoving = 0 Then
    ...
    Else
            Dim kp As Boolean
            kp = (GetKeyState(BindKeys(14).KeyCode) < 0) Or _
                GetKeyState(BindKeys(17).KeyCode) < 0 Or _
                GetKeyState(BindKeys(15).KeyCode) < 0 Or _
                GetKeyState(BindKeys(16).KeyCode) < 0
