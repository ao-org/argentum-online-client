...
Is_Transparent_Err:
    Call RegistrarError(Err.number, Err.Description, "FrmBorrarCuenta.Is_Transparent", Erl)
    Resume Next
...
Aplicar_Transparencia_Err:
    Call RegistrarError(Err.number, Err.Description, "FrmBorrarCuenta.Aplicar_Transparencia", Erl)
    Resume Next
