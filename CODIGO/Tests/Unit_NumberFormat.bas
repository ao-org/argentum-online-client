...
' PonerPuntos(999) returns "999" (no separator)
...
' PonerPuntos(1000) returns "1.000"
...
' PonerPuntos(999999) returns "999.999"
...
' PonerPuntos(1000000) returns "1.000.000"
