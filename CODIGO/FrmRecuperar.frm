...
Is_Transparent_Err:
    ...
    Exit Function
Is_Transparent_Err:
    Call TraceError(Err.Number, Err.Description, "FrmRecuperar.Is_Transparent", Erl)
End Function
...
Aplicar_Transparencia_Err:
    ...
    Exit Function
Aplicar_Transparencia_Err:
    Call TraceError(Err.Number, Err.Description, "FrmRecuperar.Aplicar_Transparencia", Erl)
End Function
...
Form_Load_Err:
    ...
    Exit Sub
Form_Load_Err:
    Call TraceError(Err.Number, Err.Description, "FrmRecuperar.Form_Load", Erl)
End Sub
...
Form_MouseMove_Err:
    ...
    Exit Sub
Form_MouseMove_Err:
    Call TraceError(Err.Number, Err.Description, "FrmRecuperar.Form_MouseMove", Erl)
End Sub
...
Image1_Click_Err:
    ...
    Exit Sub
Image1_Click_Err:
    Call TraceError(Err.Number, Err.Description, "FrmRecuperar.Image1_Click", Erl)
End Sub
...
Image1_MouseDown_Err:
    Call TraceError(Err.Number, Err.Description, "FrmRecuperar.Image1_MouseDown", Erl)
End Sub
...
Image1_MouseMove_Err:
    ...
    Exit Sub
Image1_MouseMove_Err:
    Call TraceError(Err.Number, Err.Description, "FrmRecuperar.Image1_MouseMove", Erl)
End Sub
...
Image2_Click_Err:
    ...
    Exit Sub
Image2_Click_Err:
    Call TraceError(Err.Number, Err.Description, "FrmRecuperar.Image2_Click", Erl)
End Sub
...
Image2_MouseMove_Err:
    ...
    Exit Sub
Image2_MouseMove_Err:
    Call TraceError(Err.Number, Err.Description, "FrmRecuperar.Image2_MouseMove", Erl)
End Sub
...
Image2_MouseDown_Err:
    Call TraceError(Err.Number, Err.Description, "FrmRecuperar.Image2_MouseDown", Erl)
End Sub
