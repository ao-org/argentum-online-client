...
Public Sub mostrarCartel(ByVal title As String, _
                         ByVal message As String, _
                         Optional ByVal headGrh As Long = 0, _
                         Optional ByVal duration As Long = 0, _
                         Optional ByVal titleColor As Long = -1, _
                         Optional ByVal messageColor As Long = -1, _
                         Optional ByVal backgroundColor As Long = -1, _
                         Optional ByVal EsNpc As Boolean = False, _
                         Optional ByVal CartelTitlePosX = 0, _
                         Optional ByVal CartelTitlePosY As Long = 0, _
                         Optional ByVal CartelMessagePosX As Long = 0, _
                         Optional ByVal CartelMessagePosY As Long = 0, _
                         Optional ByVal cartelGrhPosX As Long = 0, _
                         Optional ByVal cartelGrhPosY As Long = 0, _
                         Optional ByVal grhWidth As Long = 0, _
                         Optional ByVal grhHeight As Long = 0, _
                         Optional ByVal bodyGrh As Long = 0, _
                         Optional ByVal HeadOffsetY As Integer = 0)
    ...
    If UserCharIndex > 0 Then
        ...
        If cartel_duration = -1 Then
            ...
            If language = e_language.English Then
                Call Engine_Text_Render_Cartel("Click left to continue...", 516 + gameplay_render_offset.x, 572 + gameplay_render_offset.y, cartel_continue_color(), 1, False, , _
                        cartel_fade)
            Else
                Call Engine_Text_Render_Cartel("Click para continuar...", 539 + gameplay_render_offset.x, 572 + gameplay_render_offset.y, cartel_continue_color(), 1, False, , _
                        cartel_fade)
            End If
        End If
        'Renderizo ícono
...
Public Sub Engine_Text_Render_Cartel(Texto As String, _
