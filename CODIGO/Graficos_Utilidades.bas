...
Public Sub Geometry_Create_Box(ByRef verts() As TYPE_VERTEX, _
                               ByRef Dest As Rect, _
                               ByRef src As Rect, _
                               ByRef rgb_list() As RGBA, _
                               Optional ByVal Textures_Width As Long, _
                               Optional ByVal Textures_Height As Long, _
...
Public Sub PresentComposedTexture(ByVal x As Integer, _
                                  ByVal y As Integer, _
                                  ByRef light_value() As RGBA, _
                                  Optional ByVal angle As Single = 0, _
                                  Optional ByVal Shadow As Boolean = False, _
                                  Optional ByVal Reflection As Boolean = False)
