...
Private Sub Form_Load()
    ...
    Exit Sub
Form_Load_Err:
    Call TraceError(Err.Number, Err.Description, "MenuUser.Form_Load", Erl)
End Sub
...
Private Sub OpcionImg_Click(Index As Integer)
    ...
    Exit Sub
OpcionImg_Click_Err:
    Call TraceError(Err.Number, Err.Description, "MenuUser.OpcionImg_Click", Erl)
End Sub
...
OpcionImg_MouseMove_Err:
    Call TraceError(Err.Number, Err.Description, "MenuUser.OpcionImg_MouseMove", Erl)
End Sub
...
Private Sub OpcionLbl_Click(Index As Integer)
    ...
    Exit Sub
OpcionLbl_Click_Err:
    Call TraceError(Err.Number, Err.Description, "MenuUser.OpcionLbl_Click", Erl)
End Sub
...
OpcionLbl_MouseMove_Err:
    Call TraceError(Err.Number, Err.Description, "MenuUser.OpcionLbl_MouseMove", Erl)
End Sub
...
Public Sub LostFocus()
    ...
    Exit Sub
LostFocus_Err:
    Call TraceError(Err.Number, Err.Description, "MenuUser.LostFocus", Erl)
End Sub
